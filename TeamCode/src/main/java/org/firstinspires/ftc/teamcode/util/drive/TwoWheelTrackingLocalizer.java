...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -4.68504; // X is the up and down direction
    public static double PARALLEL_Y = 5.4; // Y is the strafe direction

    public static double PERPENDICULAR_X = 5.4;
    public static double PERPENDICULAR_Y = 6.14173;

    public static double X_MULTIPLIER = 1.006316; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.006316; // Multiplier in the Y direction
